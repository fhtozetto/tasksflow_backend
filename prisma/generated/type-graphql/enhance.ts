...
const modelsInfo = {
  ...
  Barcodes: ["id", "product_id", "barcode", "created_At"],
...
const outputsInfo = {
  ...
  BarcodesGroupBy: ["id", "product_id", "barcode", "created_At", "_count", "_min", "_max"],
  ...
  BarcodesCountAggregate: ["id", "product_id", "barcode", "created_At", "_all"],
  BarcodesMinAggregate: ["id", "product_id", "barcode", "created_At"],
  BarcodesMaxAggregate: ["id", "product_id", "barcode", "created_At"],
...
const inputsInfo = {
  ...
  ProductsWhereUniqueInput: ["id", "erp_code"],
  ...
  BarcodesWhereInput: ["AND", "OR", "NOT", "id", "product_id", "product", "barcode", "created_At"],
  BarcodesOrderByWithRelationInput: ["id", "product_id", "product", "barcode", "created_At"],
  BarcodesWhereUniqueInput: ["id"],
  BarcodesOrderByWithAggregationInput: ["id", "product_id", "barcode", "created_At", "_count", "_max", "_min"],
  BarcodesScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "product_id", "barcode", "created_At"],
  ...
  BarcodesCreateInput: ["id", "barcode", "created_At", "product"],
  BarcodesUpdateInput: ["id", "barcode", "created_At", "product"],
  BarcodesCreateManyInput: ["id", "product_id", "barcode", "created_At"],
  BarcodesUpdateManyMutationInput: ["id", "barcode", "created_At"],
  ...
  BarcodesCountOrderByAggregateInput: ["id", "product_id", "barcode", "created_At"],
  BarcodesMaxOrderByAggregateInput: ["id", "product_id", "barcode", "created_At"],
  BarcodesMinOrderByAggregateInput: ["id", "product_id", "barcode", "created_At"],
  ...
  BarcodesCreateWithoutProductInput: ["id", "barcode", "created_At"],
  ...
  BarcodesScalarWhereInput: ["AND", "OR", "NOT", "id", "product_id", "barcode", "created_At"],
  ...
  BarcodesCreateManyProductInput: ["id", "barcode", "created_At"],
  ValidityCreateManyProductInput: ["id", "created_at", "due_date", "finished_at"],
  BarcodesUpdateWithoutProductInput: ["id", "barcode", "created_At"],
